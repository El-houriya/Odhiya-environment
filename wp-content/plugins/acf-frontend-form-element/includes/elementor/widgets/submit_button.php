...
class Submit_Post_Widget extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        $submit_button_html = '<div class="acfef-submit-buttons"><input type="submit" class="acfef-submit-button acf-button button button-primary" value="%s" /><span class="acf-spinner"></span></div>';
        ?>
