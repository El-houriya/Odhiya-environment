...
"You can have only one payment field in your form. Please delete the existing payment field to add another one." => array( null, __("You can have only one payment field in your form. Please delete the existing payment field to add another one.", "forminator" ), ), // src/form/components/modals/fields.js:214
"You can have only one reCaptcha field in your form for Google reCaptcha to work accurately. Please delete the existing reCaptcha field to add a new one." => array( null, __("You can have only one reCaptcha field in your form for Google reCaptcha to work accurately. Please delete the existing reCaptcha field to add a new one.", "forminator" ), ), // src/form/components/modals/fields.js:224
"Need access to pro form fields? {{link}}Try Forminator Pro for FREE{{/link}}" => array( null, __("Need access to pro form fields? {{link}}Try Forminator Pro for FREE{{/link}}", "forminator" ), ), // src/form/components/modals/fields.js:304
